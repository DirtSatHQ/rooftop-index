...
nyc_buildings_file='/Volumes/NDB_HDD/final/final_geospatial/final_NYC_results_withaddress_st_is_within_distance_1_alladdresspoints.geojson'
nyc_buildings=read_sf(nyc_buildings_file)

#DUMMY TO BE REPLACED BY ACTUAL CALCULATIONS ONCE AGREED:
energy_savings_score_verbal_dummy = 'NA' # PARK FOR NOW
stormwater_capture_score_verbal_dummy = 'NA' # PARK FOR NOW
score_dummy = 'NA'
score_verbal_dummy = 'NA'
...
nyc_buildings_nona = nyc_buildings %>% dplyr::filter(!is.na(nyc_buildings$`TOPSIS score`)) 
nyc_buildings_onlyna = nyc_buildings %>% dplyr::filter(is.na(nyc_buildings$`TOPSIS score`)) 

topsis_percentile=quantile(nyc_buildings_nona$`TOPSIS score`, probs = c(0.15,0.30,0.45,0.60,0.75,0.90))

nyc_buildings_csv_matched = nyc_buildings_nona %>% dplyr::select(h_no,hno_suffix,full_stree,zipcode,`TOPSIS MCDA Rank (1 = Best)`,`TOPSIS score`,`Flat, Usable Area (ft2)`) %>%
...
nyc_buildings_csv_nomatched = nyc_buildings_onlyna %>% dplyr::select(h_no,hno_suffix,full_stree,zipcode,`TOPSIS MCDA Rank (1 = Best)`,`TOPSIS score`,`Flat, Usable Area (ft2)`) %>%
  dplyr::mutate(address_short = str_squish(paste0(nyc_buildings_onlyna$h_no," ",replace_na(nyc_buildings_onlyna$hno_suffix,"")," ",str_to_title(tolower(nyc_buildings_onlyna$full_stree)))),
                address_geo = str_squish(paste0(nyc_buildings_onlyna$h_no," ",replace_na(nyc_buildings_onlyna$hno_suffix,"")," ",str_replace_all(str_to_title(tolower(nyc_buildings_onlyna$full_stree)),
                                                                                                                                             c("1 St"="1st St","2 St"="2nd St","3 St"="3rd St","4 St"="4th St","5 St"="5th St","6 St"="6th St","7 St"="7th St","8 St"="8th St","9 St"="9th St","0 St"="0th St",
                                                                                                                                               "1 Ave"="1st Ave","2 Ave"="2nd Ave","3 Ave"="3rd Ave","4 Ave"="4th Ave","5 Ave"="5th Ave","6 Ave"="6th Ave","7 Ave"="7th Ave","8 Ave"="8th Ave","9 Ave"="9th Ave","0 Ave"="0th Ave"))
                                                ,", NY ",nyc_buildings_onlyna$zipcode, ", USA")),
                address_text = str_squish(paste0(nyc_buildings_onlyna$h_no," ",replace_na(nyc_buildings_onlyna$hno_suffix,"")," ",str_replace_all(str_to_title(tolower(nyc_buildings_onlyna$full_stree)),
                                                                                                                                              c("1 St"="1st St","2 St"="2nd St","3 St"="3rd St","4 St"="4th St","5 St"="5th St","6 St"="6th St","7 St"="7th St","8 St"="8th St","9 St"="9th St","0 St"="0th St",
                                                                                                                                                "1 Ave"="1st Ave","2 Ave"="2nd Ave","3 Ave"="3rd Ave","4 Ave"="4th Ave","5 Ave"="5th Ave","6 Ave"="6th Ave","7 Ave"="7th Ave","8 Ave"="8th Ave","9 Ave"="9th Ave","0 Ave"="0th Ave"))
                                                 ,", NY ",nyc_buildings_onlyna$zipcode, ", USA")),
                application = "",bids = "",company= "",cre_report = "",
                energy_reduction_electricity = (energy_savings_kwh_persqft * nyc_buildings_onlyna$`Flat, Usable Area (ft2)`),
                energy_reduction_heating = (energy_savings_therms_persqft * nyc_buildings_onlyna$`Flat, Usable Area (ft2)`),
                energy_savings = ((energy_savings_kwh_persqft * energy_cost_dollar_perkwh + energy_savings_therms_persqft * energy_cost_dollar_pertherm) * nyc_buildings_onlyna$`Flat, Usable Area (ft2)` * rooftop_lifetime_years),
                energy_savings_score_verbal = energy_savings_score_verbal_dummy, 
                financing = "",
                greenroof_installation_cost = 0,
                greenroof_maintenance_costs = 0,
                img_map = "",members = "",name = "",notified="",
                roi = roi_dummy,
                score = score_dummy,
                score_verbal = score_verbal_dummy,
                start_date = "", status = "", 
                stormwater_capture = 0, 
                stormwater_capture_score_verbal = stormwater_capture_score_verbal_dummy,
                stormwater_mngt_savings = 0,
                total_cost_savings = energy_savings + stormwater_mngt_savings,
                total_flat_area_pc_available = 0,
                total_flat_roof_area = 0,
                `Created Date` = "", `Modified Date` = "", Slug = "", `Created By` = "", `Unique id`=""
  )

nyc_buildings_csv=rbind(nyc_buildings_csv_matched,nyc_buildings_csv_nomatched)

nyc_buildings_csv = nyc_buildings_csv %>% dplyr::select(-c(h_no,hno_suffix,full_stree,zipcode,`TOPSIS MCDA Rank (1 = Best)`,`TOPSIS score`,geometry,`Flat, Usable Area (ft2)`))
...
rm(nyc_buildings_csv,nyc_buildings_csv_noduplicates)
