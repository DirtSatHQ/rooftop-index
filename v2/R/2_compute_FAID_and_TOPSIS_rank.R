...
#redefine roi
roi = read_sf(config_data$roi[1])

#import clipped data exported from script # 1
dsm = rast('~/dirtSAT/data/processed/raster/dsm_clipped.tif')
dem = rast('~/dirtSAT/data/processed/raster/dem_clipped.tif')
lst = (rast('~/dirtSAT/data/processed/raster/lst_clipped.tif')*9/5) + 32
footprint = read_sf('~/dirtSAT/data/processed/vector/building_footprints_clipped.shp') 
