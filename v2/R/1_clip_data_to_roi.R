...
write_sf(building_footprints_clipped, '~/dirtSAT/data/processed/vector/building_footprints_clipped.shp')
terra::writeRaster(dsm_clipped, '~/dirtSAT/data/processed/raster/dsm_clipped.tif', overwrite=TRUE)
terra::writeRaster(dem_clipped, '~/dirtSAT/data/processed/raster/dem_clipped.tif', overwrite=TRUE)
terra::writeRaster(lst, '~/dirtSAT/data/processed/raster/lst_clipped.tif', overwrite=TRUE)
